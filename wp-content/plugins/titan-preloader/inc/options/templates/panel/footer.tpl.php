...
<div id="redux-footer-sticky">
    <div id="redux-footer">
        <div class="redux-notification-success">
            <?php echo esc_html__('Settings saved successfully', 'titan'); ?>
        </div>
        <div class="redux-notification-error">
            <?php echo esc_html__('Settings could not be saved successfully', 'titan'); ?>
        </div>
        <?php
        ...
        <div id="redux-share">
            ...
            ?>
            <a href="<?php echo esc_url($links['url']); ?>" title="<?php echo esc_attr($links['title']); ?>"
                target="_blank">
